<!--
このファイルは https://google.github.io/eng-practices/ の内容を
LLM による解釈・要約・改変を一切加えず、元の Markdown ソース
(https://github.com/google/eng-practices) をそのまま一言一句書き起こしたものです。

各ページの区切りに出典 URL の見出しのみを挿入しています。本文・記法
({#anchor} 等のアンカー記法を含む) は原文のままです。
-->



<!-- ===== SOURCE: https://google.github.io/eng-practices/ (README.md) ===== -->
...
<!-- ===== SOURCE: https://google.github.io/eng-practices/review/ (review__index.md) ===== -->
...
<!-- ===== SOURCE: https://google.github.io/eng-practices/review/reviewer/ (review__reviewer__index.md) ===== -->
...
<!-- ===== SOURCE: https://google.github.io/eng-practices/review/reviewer/standard.html (review__reviewer__standard.md) ===== -->
...
<!-- ===== SOURCE: https://google.github.io/eng-practices/review/reviewer/looking-for.html (review__reviewer__looking-for.md) ===== -->
...
<!-- ===== SOURCE: https://google.github.io/eng-practices/review/reviewer/navigate.html (review__reviewer__navigate.md) ===== -->
...
<!-- ===== SOURCE: https://google.github.io/eng-practices/review/reviewer/speed.html (review__reviewer__speed.md) ===== -->
...
<!-- ===== SOURCE: https://google.github.io/eng-practices/review/reviewer/comments.html (review__reviewer__comments.md) ===== -->
...
<!-- ===== SOURCE: https://google.github.io/eng-practices/review/reviewer/pushback.html (review__reviewer__pushback.md) ===== -->
...
<!-- ===== SOURCE: https://google.github.io/eng-practices/review/emergencies.html (review__emergencies.md) ===== -->
...
<!-- ===== SOURCE: https://google.github.io/eng-practices/review/developer/ (review__developer__index.md) ===== -->
...
<!-- ===== SOURCE: https://google.github.io/eng-practices/review/developer/cl-descriptions.html (review__developer__cl-descriptions.md) ===== -->
...
<!-- ===== SOURCE: https://google.github.io/eng-practices/review/developer/small-cls.html (review__developer__small-cls.md) ===== -->
...
<!-- ===== SOURCE: https://google.github.io/eng-practices/review/developer/handling-comments.html (review__developer__handling-comments.md) ===== -->
